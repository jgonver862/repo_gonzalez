...
public class Alolatino {

	public static void main(String[] args) {
		System.out.println("Vamos a crear un cuadrado latino. Introduce la dimension");
		Scanner scanner = new Scanner(System.in);
		int n = scanner.nextInt();
		int[][] cuadradoLatino = new int[n][n];
		// Obtenemos datos del usuario para rellenar la primera fila
		for (int i = 0; i < n; i++) {
			System.out.println("Introduce el siguiente numero de la primera fila");
