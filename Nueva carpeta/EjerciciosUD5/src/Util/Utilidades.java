...
public class Utilidades {
	...
	public static boolean checkIBAN(String numerocuentaIBAN) {

		boolean IBANCorrecto = false;

		// 00000100F == 100F

		String IBANPattern = "[ES]" + "[0-9]{22}]";

		if (numerocuentaIBAN.matches(IBANPattern)) {

			String numStr = numerocuentaIBAN.substring(0, 22);

			if (numerocuentaIBAN.length() == 24) {
